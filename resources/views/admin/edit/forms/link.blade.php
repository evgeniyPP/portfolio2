<form wire:submit.prevent="submit" class="w-full mt-8">
  <div>
    <label for="selectedName" class="input-label">Выберите ссылку:</label>
  ...
  <div class="mt-6">
    ...
    <div class="relative mt-3">
      <textarea wire:model.lazy="description" id="description" class="input w-full h-32 form-input @error('description') input-error placeholder-red-300 @enderror"></textarea>
      @error('description')
        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
