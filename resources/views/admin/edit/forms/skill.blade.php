<form wire:submit.prevent="submit" class="w-full mt-8">
  <div>
    <label for="selectedName" class="input-label">Выберите навык:</label>
  ...
  <div class="w-24 mt-6">
    ...
    <div class="relative mt-3">
      <input wire:model.lazy="rank" id="rank" type="number" class="input form-input @error('rank') input-error placeholder-red-300 @enderror" placeholder="–" min="0" max="300" />
      @error('rank')
        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
  ...
  <div class="mt-6">
    ...
    <div class="relative mt-3">
      <input wire:model.lazy="logo" id="logo" class="input form-input @error('logo') input-error placeholder-red-300 @enderror" />
      @error('logo')
        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
  ...
  <div class="mt-6">
    ...
    <select wire:model.lazy="type" id="type" class="input mt-3 leading-6 border-gray-300 form-select @error('type') input-error placeholder-red-300 @enderror">
