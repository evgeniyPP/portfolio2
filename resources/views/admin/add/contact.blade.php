  ...
  <form method="post" class="w-full mt-8">
    ...
    <div>
      ...
      <div class="relative mt-3">
        <input name="name" id="name" class="input form-input @error('name') input-error placeholder-red-300 @enderror" placeholder="по телефону" value="{{ old('name') }}" />
        @error('name')
    ...
    <div class="mt-6">
      ...
      <div class="relative mt-3">
        <input name="link" id="link" class="input form-input @error('link') input-error placeholder-red-300 @enderror" placeholder="https://wa.me/79853858146" value="{{ old('link') }}" />
        @error('link')
          <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
    ...
    <div class="mt-6">
      <label for="text" class="input-label">Контакт</label>
      <div class="relative mt-3">
        <input name="text" id="text" class="input form-input @error('text') input-error placeholder-red-300 @enderror" placeholder="8-985-385-81-46" value="{{ old('text') }}" />
        @error('text')
          <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
